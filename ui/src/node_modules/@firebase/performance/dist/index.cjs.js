...
function processQueue(timeOffset) {
    setTimeout(function () {
        ...
        var staged = tslib_1.__spread(queue);
        queue = [];
        /* eslint-disable camelcase */
        ...
        fetch(SettingsService.getInstance().logEndPointUrl, {
             ...
             */
            queue = tslib_1.__spread(staged, queue);
            remainingTries--;
...
function addToQueue(evt) {
    ...
    queue = tslib_1.__spread(queue, [evt]);
}
...
serializer) {
    ...
    return function (_loggerInstance, _level) {
        ...
        var message = serializer.apply(void 0, tslib_1.__spread(args));
        addToQueue({
            message: message,
            eventTime: Date.now()
        });
...
var Trace = /** @class */ (function () {
    ...
    Trace.prototype.record = function (startTime, duration, options) {
        ...
        if (options && options.metrics) {
            try {
                for (var _b = tslib_1.__values(Object.keys(options.metrics)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var metric = _c.value;
...
function setupUserTimingTraces() {
    ...
    try {
        for (var measures_1 = tslib_1.__values(measures), measures_1_1 = measures_1.next(); !measures_1_1.done; measures_1_1 = measures_1.next()) {
