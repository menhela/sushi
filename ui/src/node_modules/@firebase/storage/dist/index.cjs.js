...
function fromBackendResponse(authWrapper, resource) {
    ...
    if (resource[PREFIXES_KEY]) {
        try {
            for (var _c = tslib_1.__values(resource[PREFIXES_KEY]), _d = _c.next(); !_d.done; _d = _c.next()) {
                var path = _d.value;
    ...
    if (resource[ITEMS_KEY]) {
        try {
            for (var _e = tslib_1.__values(resource[ITEMS_KEY]), _f = _e.next(); !_f.done; _f = _e.next()) {
                var item = _f.value;
...
function async(f) {
    return function () {
        ...
        Promise.resolve().then(function () { return f.apply(void 0, tslib_1.__spread(argsToForward)); });
    };
}
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        nextPage = _c.sent();
                        (_a = accumulator.prefixes).push.apply(_a, tslib_1.__spread(nextPage.prefixes));
                        (_b = accumulator.items).push.apply(_b, tslib_1.__spread(nextPage.items));
...
function start(f, callback, timeout) {
    ...
    function handler(success) {
        ...
        if (success) {
            triggerCallback.call.apply(triggerCallback, tslib_1.__spread([null, success], args));
            return;
        }
